...
//*****************************************************************
//
// hackerrank: https://www.hackerrank.com/challenges/accessing-inherited-functions/problem
//
// WARRANTY:
...
TEST_CASE("inherited_functions", "[cpp][medium]") {
  D d;
  int new_val;
  cin >> new_val;
  d.check(new_val);
