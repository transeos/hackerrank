...
template<> int AddElements<int>::add(const int& element) {
  element_ += element;
  return element_;
}

template<> double AddElements<double>::add(const double& element) {
  element_ += element;
  return element_;
}

template<> const string& AddElements<string>::concatenate(const string& element) {
